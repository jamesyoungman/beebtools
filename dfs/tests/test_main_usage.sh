...
if ${DFS} --file ${TEST_DATA_DIR}/acorn-dfs-sd-40t.ssd.gz
then
...
if ${DFS} --file ${TEST_DATA_DIR}/acorn-dfs-sd-40t.ssd.gz unknown-command
then
...
if ${DFS} --file ${TEST_DATA_DIR}/acorn-dfs-sd-40t.ssd.gz --dir '$$' cat
then
...
if ${DFS} --file ${TEST_DATA_DIR}/acorn-dfs-sd-40t.ssd.gz -Q cat
then
